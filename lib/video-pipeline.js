...
export async function extractFromVideoUrl({ url, analysis = 'auto', onProgress = () => {}, prefetchedReel = null }) {
  ...
  if (isEmpty) {
    ...
    throw new Error("Couldn't extract a recipe from this reel. There's no caption, no spoken narration, and the visual analysis didn't recognize a recipe. Try opening the video directly to read it, or pick a different reel.");
  }
